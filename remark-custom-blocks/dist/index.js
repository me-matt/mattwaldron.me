...
module.exports = function blockPlugin() {
  ...
  function blockTokenizer(eat, value, silent) {
    ...
    var potentialTitle = potentialBlock.title;
    var potentialBlockTitle = blockTitle;
    ...
    var titleAllowed = potentialTitle && ['optional', 'required'].includes(potentialTitle);
    var titleRequired = potentialTitle && potentialTitle === 'required';
